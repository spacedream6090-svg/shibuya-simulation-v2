...
|---|---|---|---|---|---|---|---|
| signage_on | 50,000 | 10.00 | 0.0077 | 914.2 | 0.000 | はい | 176c5527b49f584c |
| signage_off | 50,000 | 10.00 | 0.0060 | 898.9 | 0.000 | はい | fceaa5d77f5fc437 |

## baseline との差

| 構成 | 行動分布 JSD[bits] | 帰無参照 | 帰無超え | Δ呼数 | Δ書式エラー率 | final_hash 一致 |
|---|---|---|---|---|---|---|
| signage_off | 0.0009 | 0.0035 | いいえ | 0 | -0.0016 | いいえ |
