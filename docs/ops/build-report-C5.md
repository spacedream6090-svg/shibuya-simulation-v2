...
- **W17 本番生成(09-09 12:07 開始)**: プロンプト v3 SHA c5e8c1a2(390,067 呼・入力 tok 平均 467.5・7 シャード 212 MB×7)。シャード 0-4=GPU2-6(Qwen3-8B INT8・VLLM_BATCH_INVARIANT=1・conc 48・約 1,340 ctok/s=2.3 呼/s/GPU→1 シャード≈6.7 h)。シャード 5-6 は W15 第 3 回完了後に GPU0-1 で。結果: (追記予定: 呼数・出力 tok 分布・JSD・修正率・壁時計)。
- W18 再算出。
