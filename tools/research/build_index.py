...
OVERRIDE = {
 ...
 'v2-openjev-note.md': ('A', '親の一次読み(2026-09-23・第253): GitHub リポ README・TypeSafe 公式ブログ・Google の HF モデルカードを親が実読。二次情報は不使用'),
 'v2-r38-closed-output-judges-research.md': ('B', 'サブ実読(原典 18 群・2026-09-23・第253)+親確認 4 件の逐語(GenWorld 本文 Gemma3 27B/1.85M q/s/1.92e7 calls・Light Society abs・vLLM FAQ の logprob 非保証・Formzu JSNLI 0.9288)。Light Society の routing/F1 と akiFQC JNLI 0.914 は親未確認'),
 'v2-r42-social-methodology-precedents.md': ('B', 'サブ実読(原典 3・抄録 7・二次 29・2026-09-23・第255)+親検収 4 件の逐語(Moussaïd 2010 本文・Lamport 1978 PDF・Sen & Airiau 2007 PDF・Galán & Izquierdo 2005 本文=第256)。Axelrod 1986 本文・Park 2023 の TrueSkill 表・Huberman & Glance 本文は親未読'),
 'v2-r41-cognitive-architecture-precedents.md': ('B', 'サブ実読(原典 8・空欄 24・2026-09-23・第255)+親検収(第256): Kinny 1991 / Schut 2001 / Fox 2006 / PIANO §2 / System-1.5 を逐語確認。**Moussaid 2011 の逐語 1 件が原典に無く親が訂正**。Niederberger & Gross 2005 本文(Springer 認証)・CoALA 本文・Botvinick の式は親未確認'),
