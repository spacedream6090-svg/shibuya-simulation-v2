...
- **思考の量が人に届いていない**。LLM 呼 6.9/体/日 に対し人の思考は 4,000〜6,240/日(1/580〜900)。会話は 0.0021 セッション/体/日(体の 99.8% は 1 日会話しない)。([思考頻度ノート](docs/research/v2-thought-frequency-anchors-note.md))
